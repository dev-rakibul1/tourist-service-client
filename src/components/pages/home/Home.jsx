          ...
          <div className="card flex-shrink-0 max-w-sm w-[50%]">
            <div className="">
              <p className="hero-details">
                The most popular place tour in the world. our traveling area is
                very popular in the world and most of the people like it. There
                are have any type of comfort tools for enjoy the people.
              </p>
